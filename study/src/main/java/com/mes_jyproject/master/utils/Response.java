...
public class Response<T> implements Serializable {
    ...
    private final int TOTALCOUNT;          // 총 응답 데이터 수
    ...
    public static class ResponseBuilder<T> {
        ...
        private int TOTALCOUNT;  // 총 응답 데이터 수
